...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="container-custom flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center">
          <a
            ...
            className="flex items-center text-poda-blue hover:text-poda-orange transition-colors font-medium mr-6"
          >
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-40 bg-white pt-20 transform transition-transform duration-300 ease-in-out lg:hidden ${
      ...
      >
        <div className="container px-4 py-6 flex flex-col">
          <nav className="flex flex-col space-y-6">
            <Link 
              to="/" 
              className="text-poda-blue hover:text-poda-orange font-medium text-xl transition-colors"
            ...
            <Link 
              to="/internet-tv" 
              className="text-poda-blue hover:text-poda-orange font-medium text-xl transition-colors flex items-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
            ...
            <div className="border-t border-gray-100 pt-6 mt-4">
              <a
                href="tel:+420730431313"
                className="flex items-center text-poda-blue hover:text-poda-orange transition-colors font-medium text-xl mb-6"
              >
