...
const HeroBackground = () => {
  return (
    <div className="absolute inset-0" aria-hidden="true">
      ...
      <div className="absolute -top-24 -right-24 w-96 h-96 bg-blue-100/40 dark:bg-blue-900/20 rounded-full filter blur-3xl opacity-30"></div>
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-orange-100/40 dark:bg-orange-900/20 rounded-full filter blur-3xl opacity-30"></div>
    </div>
  );
};
