      ...
      <div className="container-custom relative z-10">
        {showAnimations ? (
          ...
          <div style={{ opacity: 1 }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              <div className="group relative bg-white/90 backdrop-blur-xl rounded-3xl p-8 border border-white/40 shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(15,76,129,0.3)] hover:border-poda-blue/40 transition-all duration-500"
                style={{ boxShadow: '0 10px 40px -10px rgba(15, 76, 129, 0.15)' }}>
                <div className="absolute inset-0 bg-gradient-to-br from-poda-blue/8 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative flex flex-col items-center text-center">
                  <div className="bg-gradient-to-br from-poda-blue to-poda-blue-light p-5 rounded-2xl mb-6 shadow-lg group-hover:scale-110 transition-all duration-500">
              ...
              <div className="group relative bg-white/90 backdrop-blur-xl rounded-3xl p-8 border border-white/40 shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(255,107,53,0.3)] hover:border-poda-orange/40 transition-all duration-500"
                style={{ boxShadow: '0 10px 40px -10px rgba(255, 107, 53, 0.15)' }}>
                <div className="absolute inset-0 bg-gradient-to-br from-poda-orange/8 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative flex flex-col items-center text-center">
                  <div className="bg-gradient-to-br from-poda-orange to-poda-orange-light p-5 rounded-2xl mb-6 shadow-lg group-hover:scale-110 transition-all duration-500">
                    <svg className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
