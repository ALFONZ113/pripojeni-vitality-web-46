...
const HeroContent = ({ handleContactClick }: HeroContentProps) => {
  ...
  return (
    <div className="text-center lg:text-left">
      ...
      <motion.h1 id="hero-title" variants={item} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-poda-blue mb-6 leading-tight tracking-tight">
