...
const WhyPopriSection = () => {
  return (
    <motion.div 
      ...
      viewport={{ once: true }} 
      className="mt-16 mb-8 max-w-4xl mx-auto bg-card/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-border"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Jsme popři vás, když potřebujete rychlé PODA internet, připojení bez čekání.</p>
        </div>
        <div className="text-center">
          <h3 className="font-semibold text-lg text-poda-blue mb-2">Spolehlivost</h3>
          <p className="text-muted-foreground">Získáte stabilní PODA internet, na který se můžete spolehnout.</p>
        </div>
        <div className="text-center">
          <h3 className="font-semibold text-lg text-poda-blue mb-2">Podpora</h3>
          <p className="text-muted-foreground">Jsme vždy popři vás, když potřebujete pomoc s vaším PODA internetem.</p>
        </div>
      </div>
    </motion.div>
  );
