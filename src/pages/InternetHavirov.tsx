  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Najrýchlejší internet PODA v Havířove s optickou technológiou GPON. Rýchlosť až 1000 Mbps, bezplatná inštalácia. Pokrytie: Šumbark, Město, Podlesí, Prostřední Suchá." />
              ...
              <div className="bg-gradient-to-br from-poda-blue to-blue-800 text-white p-8 rounded-xl">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold">299 Kč/mes</span>
                  </div>
                  <div className="flex justify-between items-center">
