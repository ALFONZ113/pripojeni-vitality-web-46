  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="keywords" content="internet Karviná, PODA Karviná, optické připojení Karviná, gigabitový internet Karviná, rychlý internet Karviná, GPON Karviná, internet Ráj Karviná, internet Hranice Karviná, připojení internetu Karviná, optická vlákna Karviná, vysokorychlostní internet Karviná" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Průmyslové město s nejmodernějším optickým připojením až 1000 Mbps u polských hranic
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12 text-poda-blue">
              Proč si vybrat PODA internet v Karviné?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2">Příhraniční výhoda</h3>
                    <p className="text-gray-600">Karviná má přímé propojení s mezinárodní optickou sítí díky poloze na polských hranicích.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Díky kompaktnosti města zajistíme bezplatnou rychlou instalaci od objednání.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <Star className="h-6 w-6 text-poda-orange mt-1 mr-4 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-lg mb-2">Mezinárodní připojení</h3>
                    <p className="text-gray-600">Přímé optické spojení s Polskem pro nejnižší latence v Evropě.</p>
                  </div>
                </div>
              </div>
              <div className="bg-gradient-to-br from-poda-blue to-blue-800 text-white p-8 rounded-xl">
                <h3 className="font-bold text-xl mb-4">Exkluzivní ceny pro Karviná</h3>
      ...
      <section className="py-16 bg-poda-orange text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Připojte Karviná k nejrychlejšímu internetu v regionu
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Mezinárodní kvalita internetu přímo ve vašem domě!
          </p>
