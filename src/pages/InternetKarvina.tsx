  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Najrýchlejší internet PODA v Karviné s optickou technológiou GPON. Rýchlosť až 1000 Mbps, bezplatná inštalácia. Pokrytie: Ráj, Hranice, Mizerova, Nové Město." />
