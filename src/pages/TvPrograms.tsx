...
const TvPrograms = () => {
  ...
  // Dětské a mládež
  {
    ...
    category: 'detske',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=ČT:D'
  }, {
    id: 2,
    name: 'Disney Channel',
    category: 'detske',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Disney'
  }, {
    id: 3,
    name: 'Nickelodeon',
    category: 'detske',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Nick'
  }, {
    id: 4,
    name: 'Cartoon Network',
    category: 'detske',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=CN'
  }, {
    id: 5,
    name: 'Minimax',
    category: 'detske',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Minimax'
  }, {
    id: 6,
    name: 'JimJam',
    category: 'detske',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=JimJam'
  }, {
    id: 7,
    name: 'Duck TV',
    category: 'detske',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=DuckTV'
  },
  // Zpravodajství
  {
    id: 8,
    ...
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=ČT24'
  }, {
    id: 9,
    name: 'CNN Prima News',
    category: 'zpravodajstvi',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=CNN'
  }, {
    id: 10,
    name: 'BBC World News',
    category: 'zpravodajstvi',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=BBC'
  }, {
    id: 11,
    name: 'TA3',
    category: 'zpravodajstvi',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=TA3'
  }, {
    id: 12,
    name: 'Euronews',
    category: 'zpravodajstvi',
    hd: false,
    logo: 'https://via.placeholder.com/50x30?text=Euronews'
  },
  // Dokumenty a kultura
  {
    id: 13,
    ...
    category: 'dokumenty',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=NatGeo'
  }, {
    id: 14,
    name: 'Discovery Channel',
    category: 'dokumenty',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Discovery'
  }, {
    id: 15,
    name: 'ČT art',
    category: 'dokumenty',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=ČT art'
  }, {
    id: 16,
    name: 'Spektrum',
    category: 'dokumenty',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Spektrum'
  }, {
    id: 17,
    name: 'Viasat History',
    category: 'dokumenty',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Viasat'
  }, {
    id: 18,
    name: 'Animal Planet',
    category: 'dokumenty',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Animal'
  }, {
    id: 19,
    ...
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=History'
  },
  // Filmy a seriály
  {
    id: 20,
    ...
    category: 'filmy',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Nova Cinema'
  }, {
    id: 21,
    name: 'Prima Max',
    category: 'filmy',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Prima Max'
  }, {
    id: 22,
    name: 'AXN',
    category: 'filmy',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=AXN'
  }, {
    id: 23,
    name: 'AMC',
    category: 'filmy',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=AMC'
  }, {
    id: 24,
    name: 'Film Europe',
    category: 'filmy',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Film Europe'
  }, {
    id: 25,
    name: 'HBO HD',
    category: 'filmy',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=HBO'
  }, {
    id: 26,
    name: 'HBO2 HD',
    category: 'filmy',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=HBO2'
  }, {
    id: 27,
    name: 'HBO3 HD',
    category: 'filmy',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=HBO3'
  }, {
    id: 28,
    name: 'Cinemax HD',
    category: 'filmy',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Cinemax'
  },
  // Sport
  {
    id: 29,
    ...
    category: 'sport',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Eurosport1'
  }, {
    id: 30,
    name: 'Eurosport 2',
    category: 'sport',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Eurosport2'
  }, {
    id: 31,
    name: 'Nova Sport 1',
    category: 'sport',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=NovaSport1'
  }, {
    id: 32,
    name: 'Nova Sport 2',
    category: 'sport',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=NovaSport2'
  }, {
    id: 33,
    name: 'ČT sport',
    category: 'sport',
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=ČTsport'
  }, {
    id: 34,
    name: 'Arena Sport 1',
    category: 'sport',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Arena1'
  }, {
    id: 35,
    name: 'Arena Sport 2',
    category: 'sport',
    premium: true,
    hd: true,
    logo: 'https://via.placeholder.com/50x30?text=Arena2'
  },
        ...
        <div className="container-custom">
          <div className="overflow-x-auto">
            <div className="flex space-x-2 min-w-max">
              {categories.map(category => <button key={category.id} onClick={() => setActiveCategory(category.id)} className={`px-4 py-2 rounded-full font-medium transition-colors ${activeCategory === category.id ? 'bg-poda-blue text-white' : 'text-gray-700 hover:bg-gray-100'}`}>
                  {category.name}
                </button>)}
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="bg-gray-50 p-4 rounded-lg mb-8">
            <div className="flex items-center justify-between">
              ...
              {activeCategory !== 'premium' && <div className="flex items-center text-sm text-gray-600">
                  <span className="mr-4">
            ...
            {filteredChannels.map(channel => <div key={channel.id} className="bg-white rounded-lg border border-gray-100 p-4 flex items-center shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {channel.premium ? <span className="inline-block text-xs bg-poda-orange/10 text-poda-orange px-2 py-0.5 rounded-full">
                      Prémiový kanál
                    </span> : <span className="inline-block text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full">
                      Základní nabídka
                    </span>}
                </div>
              </div>)}
