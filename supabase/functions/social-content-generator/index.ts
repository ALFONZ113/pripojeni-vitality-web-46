...
const CZECH_ONLY_INSTRUCTION = `\n\nKRITICKÝ JAZYKOVÝ POŽADAVEK: Piš VÝHRADNĚ v českém jazyce (čeština). NEPOUŽÍVEJ slovenštinu ani jiný jazyk. Používej české tvary: "Jak" (ne "Ako"), "sdílení" (ne "zdieľanie"), "použitelů" (ne "používateľov"), "pouze" (ne "len"), "protože" (ne "pretože"), "potřebujete" (ne "potrebujete"), "připojení" (ne "pripojenie"), "služby" (ne "služby"), "nabídka" (ne "ponuka"). Veškeré texty, hashtagy i popisy musí být v češtině s českými diakritickými znaménky (č, š, ž, ř, ď, ť, ň, ů, ý, á, í, é).`;

const postTemplates: Record<string, { systemPrompt: string; fbPrompt: string; igPrompt: string; imagePrompt: string; hashtags: string[] }> = {
  promo: {
    systemPrompt: `Jsi expert na sociální sítě pro českého poskytovatele internetu popri.cz (autorizovaný partner PODA). Piš VÝHRADNĚ v češtině, moderně a přátelsky. Zdůrazňuj: gigabitová rychlost, 85+ TV programů, nulová aktivace. Ceny: od 300 Kč/měsíc.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš poutavý Facebook příspěvek pro popri.cz o promo akci. Zmíň: 1000/1000 Mbps, 85+ TV, 0 Kč aktivace, od 300 Kč/měsíc. CTA: 730 431 313. Délka: 150-250 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš krátký Instagram příspěvek pro popri.cz o promo akci. Gigabit + TV od 300 Kč/měsíc. Délka: 80-120 slov. PIŠE POUZE ČESKY.`,
  ...
  blog: {
    systemPrompt: `Jsi expert na sociální sítě. Napiš teaser pro blog článek z popri.cz. Piš VÝHRADNĚ v češtině, přátelsky.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook teaser pro blog článek. Vzbuď zájem. Délka: 100-150 slov. Zakonči "Přečtěte si více na popri.cz". PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram teaser pro blog. Krátký s emoji. Délka: 60-100 slov. Zmíň "odkaz v bio". PIŠE POUZE ČESKY.`,
  ...
  review: {
    systemPrompt: `Jsi expert na sociální sítě. Napiš příspěvek s recenzí zákazníka popri.cz. Autentický tón. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook příspěvek s recenzí zákazníka. Formát citátu. Délka: 100-150 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram příspěvek s recenzí. Krátký citát s ⭐. Délka: 60-100 slov. PIŠE POUZE ČESKY.`,
  ...
  tip: {
    systemPrompt: `Jsi expert na internet. Sdílíš užitečné tipy. Piš jednoduše, prakticky. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook tip o WiFi/internet optimalizaci. Formát "Věděli jste..." Délka: 100-150 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram tip s 💡. Seznam bodů. Délka: 60-100 slov. PIŠE POUZE ČESKY.`,
  ...
  news: {
    systemPrompt: `Jsi PR specialista pro popri.cz. Sdílíš novinky. Profesionální ale přátelský tón. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook příspěvek o novince popri.cz. Zdůrazni přínos. Délka: 100-150 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram příspěvek o novince s 🎉. Délka: 60-100 slov. PIŠE POUZE ČESKY.`,
  ...
  custom: {
    systemPrompt: `Jsi expert na sociální sítě pro popri.cz. Příspěvek na míru. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook příspěvek podle zadaného tématu. Délka: 100-200 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram příspěvek podle tématu. Krátký s emoji. Délka: 60-120 slov. PIŠE POUZE ČESKY.`,
    imagePrompt: `Custom social media graphic. Flexible design. ALL TEXT IN CZECH.`,
    hashtags: ['#popri', '#internet', '#ostrava'],
  },
  success: {
    systemPrompt: `Jsi expert na sociální sítě pro popri.cz. Vytváříš příběhy úspěšných zákazníků. Piš autenticky, emotivně. Zdůrazni transformaci "před/po". Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook příspěvek s příběhem úspěšného zákazníka popri.cz. Formát: konkrétní příběh s detaily. "Před popri.cz" vs "Po popri.cz". Délka: 150-250 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram příspěvek s příběhem zákazníka. Krátký emotivní příběh. Před/Po formát. Délka: 80-120 slov. PIŠE POUZE ČESKY.`,
  ...
  product: {
    systemPrompt: `Jsi expert na sociální sítě pro popri.cz. Prezentuj konkrétní tarif nebo službu. Jasně a přesvědčivě. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook příspěvek prezentující tarif/službu popri.cz. Konkrétní parametry: rychlost, cena, TV, bonus. Délka: 120-180 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram příspěvek o produktu/tarifu. Klíčová čísla. Délka: 60-100 slov. PIŠE POUZE ČESKY.`,
  ...
  photo: {
    systemPrompt: `Jsi expert na sociální sítě pro popri.cz. Příspěvky s fotorealistickými vizuály. Autenticky a přirozeně. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš Facebook příspěvek doprovázený realistickou fotografií. Přirozený tón. Délka: 100-150 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš Instagram příspěvek s autentickým lifestyle tónem. Jako u reálné fotky. Délka: 60-100 slov. PIŠE POUZE ČESKY.`,
  ...
  meme: {
    systemPrompt: `Jsi expert na virální obsah a memy pro popri.cz. Vtipné příspěvky o internetu a WiFi. Český humor, relatable situace. Vtipný ale ne urážlivý. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš vtipný Facebook meme text pro popri.cz. Téma: pomalý internet, WiFi výpadky. Formát "Když..." meme styl. Délka: 50-100 slov. MAXIMÁLNĚ VTIPNÝ. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš vtipný Instagram meme. Ultra krátký virální humor o internetu. Délka: 30-60 slov. PIŠE POUZE ČESKY.`,
  ...
  education: {
    systemPrompt: `Jsi expert na vzdělávací obsah o internetu pro popri.cz. Vysvětluj složité koncepty jednoduše. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
    fbPrompt: `Napiš vzdělávací Facebook příspěvek. Formát "Věděli jste?" s čísly a fakty. Vysvětli: GPON, WiFi 6, optika vs měď. Délka: 120-180 slov. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš vzdělávací Instagram příspěvek. Přehledný formát s emoji a čísly. Carousel-style body. Délka: 60-100 slov. PIŠE POUZE ČESKY.`,
  ...
  'fb-ad': {
    systemPrompt: `Jsi expert na Facebook Ads pro popri.cz. Vysoce konverzní reklamní texty. Stručně a přesvědčivě. Primární text max 125 znaků. Piš VÝHRADNĚ v češtině.${CZECH_ONLY_INSTRUCTION}`,
...
Zdůrazni: gigabit, od 300 Kč/měs, 0 Kč aktivace. PIŠE POUZE ČESKY.`,
    igPrompt: `Napiš krátký reklamní text pro Instagram Ads. Max 125 znaků. Stručný a přesvědčivý. PIŠE POUZE ČESKY.`,
