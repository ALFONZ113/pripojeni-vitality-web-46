	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Legacy poda colors mapped to new theme
				poda: {
					blue: 'hsl(38, 92%, 50%)',
					'blue-light': 'hsl(38, 70%, 60%)',
					orange: 'hsl(38, 92%, 50%)',
					'orange-light': 'hsl(38, 70%, 60%)',
				}
			},
			fontFamily: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { 
						boxShadow: '0 0 20px hsl(38, 92%, 50%, 0.4)' 
					},
					'50%': { 
						boxShadow: '0 0 30px hsl(38, 92%, 50%, 0.8)' 
					},
				},
				'shimmer': {
